...
def main(args):
    ...
    if configs.train.do:
        ...
        out_directory = os.path.join(exp_configs.out_directory, exp_configs.exp_name)
        os.makedirs(out_directory, exist_ok=True)

        save_config(configs, os.path.join(out_directory, "exp_config.yaml"))
