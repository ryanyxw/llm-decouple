...
save_folder="/home/ryan/decouple/models/olmo_ckpt/prefromscratch/0-99-toxic_0-0001-safe/activationbias_extreme_exp3"

wandb_name="activationbias_extreme_exp3"
...
# for adding class bias to the last hidden state
add_class_bias=True
num_classes=2
