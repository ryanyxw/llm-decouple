...
class OlmoAttention(nn.Module):
    ...
    # TODO(joao): add me back asap :)
    def __init__(self, config: OlmoCustomConfig, layer_idx: Optional[int] = None):
        super().__init__()
        self.config = config
...
class OlmoDecoderLayer(nn.Module):
    def __init__(self, config: OlmoCustomConfig, layer_idx: int):
        super().__init__()
        self.hidden_size = config.hidden_size
...
class OlmoCustomModel(OlmoPreTrainedModel):
    """
